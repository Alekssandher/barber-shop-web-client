...
import { IDialogicManagerService } from '../../../services/idialog-manager.service';
...
export class ScheduleCalendarComponent implements AfterViewInit, OnChanges, OnDestroy{
  ...
  constructor(
    @Inject(SERVICES_TOKEN.DIALOG)private readonly dialogManagerService: IDialogicManagerService
  ) {}
